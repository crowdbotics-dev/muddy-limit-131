"""
Django settings for muddy_limit_131 project.
...
ROOT_URLCONF = 'muddy_limit_131.urls'
...
WSGI_APPLICATION = 'muddy_limit_131.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_limit_131 API",
    "DESCRIPTION": "API documentation for muddy_limit_131 App",
    "VERSION": "v1",
}
